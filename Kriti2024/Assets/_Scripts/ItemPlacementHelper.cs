...
public class ItemPlacementHelper
{
    ...
    {
        HashSet<Vector2Int> roomFloor = room.emptyRoomFloor;
        Graph graph = new Graph(roomFloor);

        HashSet<Vector2Int> roomFloorNoCorridor = new HashSet<Vector2Int>(roomFloor);
        roomFloorNoCorridor.ExceptWith(DungeonState.corridors);
        this.roomFloorNoCorridor = roomFloorNoCorridor;
    ...
    public Vector2Int? GetItemPlacementPosition(PlacementType placementType, int iterationsMax, Vector2Int size, bool addOffset = true)
    {
